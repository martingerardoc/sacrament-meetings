                ...
                <div className="mt-6 grid gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            name="date"
                            type="date"
                            defaultValue={String(state.values?.date ?? '')}
                            required
                            aria-describedby={
                                state.errors?.date
                                    ? 'date-error'
                    ...
                    <div>
                        ...
                        <select
                            ...
                            name="meetingType"
                            defaultValue={String(
                                state.values?.meetingType ?? 'regular'
                            )}
                            required
                            aria-describedby={
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="presiding"
                            type="text"
                            defaultValue={String(state.values?.presiding ?? '')}
                            required
                            aria-describedby={
                ...
                <div className="mt-6 grid gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            min="1"
                            defaultValue={String(
                                state.values?.openingHymnNumber ?? ''
                            )}
                            required
                            aria-describedby={
                ...
                <div className="mt-6 grid gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            type="number"
                            defaultValue={String(
                                state.values?.sacramentHymnNumber ?? ''
                            )}
                            min="1"
                            required
                            aria-describedby={
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            defaultValue={String(
                                state.values?.sacramentHymnTitle ?? ''
                            )}
                            required
                            aria-describedby={
            ...
            <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div className="mt-6">
                    ...
                    <textarea
                        ...
                        name="speakers"
                        rows={7}
                        defaultValue={String(state.values?.speakers ?? '')}
                        placeholder={`[
  {
    "name": "John Smith",
    "topic": "Faith",
                ...
                <div className="mt-6 grid gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            min="1"
                            defaultValue={String(
                                state.values?.closingHymnNumber ?? ''
                            )}
                            required
                            aria-describedby={
